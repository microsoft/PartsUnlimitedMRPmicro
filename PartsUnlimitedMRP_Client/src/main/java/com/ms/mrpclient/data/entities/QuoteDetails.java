...
//  Front end 
  ...
  //End    
    ...
    public QuoteDetails(QuoteDetails quote) {
...
//  End
    ...
    public boolean equals(Object o)
    {
        ...
        QuoteDetails quote = (QuoteDetails) o;
        ...
        if (terms != null ? !terms.equals(quote.terms) : quote.terms != null) return false;
        if (unitDescription != null ? !unitDescription.equals(quote.unitDescription) : quote.unitDescription != null) return false;        
        if (Double.compare(quote.unitCost, unitCost) != 0) return false;
        if (Double.compare(quote.height, height) != 0) return false;
        if (Double.compare(quote.width, width) != 0) return false;
        if (Double.compare(quote.depth, depth) != 0) return false;
        if (Integer.compare(quote.unit, unit) != 0) return false;
        if (purpose != null ? !purpose.equals(quote.purpose) : quote.purpose != null) return false;
        if (Double.compare(quote.ambientPeak, ambientPeak) != 0) return false;
        if (Double.compare(quote.ambientAverage, ambientAverage) != 0) return false;
         //   end
...
//        Front end
        if (additionalItems.size() != quote.additionalItems.size()) return false;
...
public class QuoteDetails {
	...
	public QuoteItemInfo[] getQuoteItems() {
		return quoteItems;
	}
	public void setQuoteItems(QuoteItemInfo[] quoteItems) {
		this.quoteItems = quoteItems;
	}
	public double getTotalCost() {
		return totalCost;
	...
	public String toString() {
		return "QuoteDetails [quoteId=" + quoteId + ", validUntil=" + validUntil + ", customerName=" + customerName
				+ ", dealerName=" + dealerName + ", quoteItems=" + Arrays.toString(quoteItems) + ", totalCost="
				+ totalCost + ", discount=" + discount + ", city=" + city + ", postalCode=" + postalCode + ", state="
				+ state + "]";
	}
}
*/