...
(function () {
    ...
    WinJS.UI.Pages.define("./resources/pages/extras/extras.jsp", {
        ...
        ready: function (element, options) {
            ...
            return WinJS.UI.processAll(element).then(function () {
                ...
                return Data.catalogGet().then(function (catalog) {
                    ...
                    that.extrasData = new WinJS.Binding.List()
                    if(that.additionalItems)
                    {
                    	that.extrasData = that._getCatalogEntriesForExtras(that.additionalItems);
                    }
                    if(that.extrasData)
                    {
                    	that.extrasData = that._getCatalogEntriesForExtras(that.extrasData);
                    }
                ...
                case 'save': {
                    ...
                    return Data.catalogSave(this.currentItem).then(function (saved) {
                        if (saved) {
                        	...
                        	that.additionalItems = that.extrasData;
