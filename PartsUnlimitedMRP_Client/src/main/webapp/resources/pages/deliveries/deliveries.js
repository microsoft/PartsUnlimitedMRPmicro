...
(function () {
    ...
    WinJS.UI.Pages.define("./resources/pages/deliveries/deliveries.jsp", {
        ...
        _extrasHandler: function (args) {
            popup("deliveryExtrasPopup", "Manage Extras", "./resources/pages/extras/extras.jsp", this.currentItem.__quote);
        },
        _deliveryEventsHandler: function (args) {
            popup("deliveryExtrasPopup", "Manage Delivery Events", "./resources/pages/orderevents/orderevents.jsp", this.currentItem);
        },
        _orderEventsHandler: function (args) {
            popup("deliveryExtrasPopup", "Manage Order Events", "./resources/pages/orderevents/orderevents.jsp", this.currentItem.__order);
        },
                ...
                case 'save': {
                    Data.deliverySave(this.currentItem, this.originalItem).then(function (saved) {
                        if (saved) {
                            ...
                            if(index == -1)
                            { 
                            	index = Data.getIndexOfObject(saved, Data.deliveries, 'deliveries');
                            	if(index > -1)
                            	{
                            		Data.deliveries.setAt(index, saved);
                            	}
                            }
