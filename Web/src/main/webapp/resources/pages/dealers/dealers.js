...
(function () {
    ...
    WinJS.UI.Pages.define("./resources/pages/dealers/dealers.jsp", {
        ...
        ready: function (element, options) {
            ...
            return Data.dealersGet().then(function (dealers) {
                ...
                //TODO commented temporarily .. need to handle google map key issue in util.js of WinJS
                ...
                case 'save': {
                    Data.dealerSave(this.currentItem).then(function (saved) {
                        if (saved) {
                            ...
                            if(index == -1)
                            { 
                            	index = Data.getIndexOfObject(saved, Data.dealers, 'dealers');
                            	if(index > -1)
                            	{
                            		Data.dealers.setAt(index, saved);
                            	}
                            }
