...
(function () {
    ...
    WinJS.UI.Pages.define("./resources/pages/orderevents/orderevents.jsp", {
        ...
        _buttonHandler: function (args) {
            ...
            switch (args.label) {
                case 'save': {
                    ...
                    if(index == -1)
                    { 
                    	index = Data.getIndexOfObject(saved, Data.ordereventsData, 'ordereventsData');
                    	if(index > -1)
                    	{
                    		Data.ordereventsData.setAt(index, saved);
                    	}
                    }
