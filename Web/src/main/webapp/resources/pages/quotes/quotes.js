...
(function () {
    ...
    WinJS.UI.Pages.define("./resources/pages/quotes/quotes.jsp", {
        ...
        _extrasHandler: function (args) {
            popup("quoteExtrasPopup", "Manage Extras", "./resources/pages/extras/extras.jsp", this.currentItem);
        },
        _buttonHandler: function (args) {
            ...
            switch (args.label) {
                case 'save': {
                    Data.quoteSave(this.currentItem).then(function (saved) {
                        if (saved) {
                            ...
                            if(index == -1)
                            { 
                            	index = Data.getIndexOfObject(saved, Data.quotes, 'quotes');
                            	if(index > -1)
                            	{
                            		Data.quotes.setAt(index, saved);
                            	}
                            }
                ...
                case 'edit': {
                    nav.navigate("./resources/pages/orders/orders.jsp", { quote: that.currentItem });
                    break;
                }
                case 'delete': {
